...
covm=cov(feature_train_test',1);
covm=covm+eye(n_sample_full)*(1/3);
...
[ beta_0_test ] = beta_optimization_LP_instant_ts(ldp,n_beta,beta_0_current,v,l_matrix,x_valid,n_sample_full,eig_tol,tol_set,mo,L, ...
...
lambda=sum(repmat(beta_0_test(1:end-1),[n_sample_full 1]).*l_matrix,2)+beta_p_const+eig_tol;
