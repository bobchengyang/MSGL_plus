...
acc_time_all=zeros(20,7);

load electronics_Cholesky_img.mat
acc_time_all(:,1)=acc_time(:,3);
load electronics_PDcone_img.mat
acc_time_all(:,2)=acc_time(:,3);
load electronics_HBNB_img.mat
acc_time_all(:,3)=acc_time(:,3);
load electronics_SGML_img.mat
acc_time_all(:,4)=acc_time(:,3);
load electronics_PGML_img.mat
acc_time_all(:,5)=acc_time(:,3);
load electronics_MSGL_img.mat
acc_time_all(:,6)=acc_time(:,3);
load electronics_MSGL_new_img_binary.mat
acc_time_all(:,7)=acc_time(:,3);
...
% end
% 
% [datasize_order_value,datasize_order_idx]=sort(results_time(1:end-1,6));
% datasize_order_idx=[datasize_order_idx; 21];
% 
