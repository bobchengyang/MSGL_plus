function [error_classifier,method_time,error_classifier0] = ...
...
% for net_iter=1:1
    [error_classifier0,x_valid] = classifier(dataset_i,n_beta,class_test, ...
        feature_train_test, ...
        initial_label_index, ...
        class_train_test, ...
        classifier_i,...
        ...
        beta_0_current,...
        learning_i);
    disp(['classifier before MSGL ' num2str(classifier_i) ' | accuracy: ' num2str((1-error_classifier0)*100)]);
