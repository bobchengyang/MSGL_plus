function [fu, fu_CMN, q, u, l] = harmonic_function_xiaojin(L, fl, indices_known)
% [fu, fu_CMN] = harmonic_function_xiaojin(W, fl)
%
...
n = size(L, 1); % total number of points
u = n - l;
...
fu = - inv(L(~indices_known,~indices_known)) * L(~indices_known,indices_known) * fl;
