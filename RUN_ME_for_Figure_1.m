...
acc_time_all=zeros(15,7);

load electronics_Cholesky_binary.mat
acc_time_all(:,1)=acc_time(:,end);
load electronics_PDcone_binary.mat
...
load electronics_MSGL_binary.mat
acc_time_all(:,6)=acc_time(:,end);
load electronics_MSGL_new_binary_multi.mat
acc_time_all(:,7)=acc_time(1:15,end);
...
size_temp=zeros(15,1);
    for dataset_i=1:15
        ...
        size_temp(dataset_i)=size(read_data,1);
    end
...
datasize_order_idx=[datasize_order_idx; 16];
% 
