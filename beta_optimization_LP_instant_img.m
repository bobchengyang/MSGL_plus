function [ beta_0 ] = beta_optimization_LP_instant_img( ldp,n_beta,beta_0,v,l_matrix,data_label,n_sample,eig_tol,tol_set,mo,L,...
...
while iter>200
    ...
    while obj_net>1e-2
        ...
        [ alpha_0 ] = GSL_LP_stepsize_instant_img(ldp, ...
            beta_0,...
            FW_beta_direction,...
            l_matrix,...
            eig_tol,...
        ...
        %         disp(['check_times: ' num2str(check_times)]);
