...
% for net_iter=1:1
    [error_classifier_0,x_valid,denoised_img1] = classifier_img(dataset_i,n_beta,class_test, ...
        feature_train_test, ...
        initial_label_index, ...
        class_train_test, ...
        classifier_i,...
...
% imwrite(denoised_img1,'denoised_noMSGL_saturn.png','png');
...
[error_classifier,~,denoised_img2] = classifier_img(dataset_i,n_beta,class_test, ...
    feature_train_test, ...
    initial_label_index, ...
    class_train_test, ...
    classifier_i,...
...
imwrite(denoised_img2,['matlab_img_' str '_binary_denoised.png'],'png');
% error_classifier
% % 
% % % [M] = ...
